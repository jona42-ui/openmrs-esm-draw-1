...
var TimePicker = /*#__PURE__*/React__default["default"].forwardRef(function TimePicker(_ref, ref) {
  ...
  var timePickerClasses = cx__default["default"]((_cx2 = {}, _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker"), true), _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker--light"), light), _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker--invalid"), invalid), _rollupPluginBabelHelpers.defineProperty(_cx2, "".concat(prefix, "--time-picker--").concat(size), size), _rollupPluginBabelHelpers.defineProperty(_cx2, className, className), _cx2));
  var labelClasses = cx__default["default"]("".concat(prefix, "--label"), (_cx3 = {}, _rollupPluginBabelHelpers.defineProperty(_cx3, "".concat(prefix, "--visually-hidden"), hideLabel), _rollupPluginBabelHelpers.defineProperty(_cx3, "".concat(prefix, "--label--disabled"), disabled), _cx3));
...
exports["default"] = TimePickerNext;

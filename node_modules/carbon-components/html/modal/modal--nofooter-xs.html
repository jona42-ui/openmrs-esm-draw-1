...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rsh2pboa3p">Show
  modal</button>

<div data-modal id="modal-rsh2pboa3p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rsh2pboa3p-label" aria-describedby="modal-rsh2pboa3p-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rsh2pboa3p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rsh2pboa3p-heading">Modal heading</p>

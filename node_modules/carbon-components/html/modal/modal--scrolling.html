...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-e46ndrv7e9">Show
  modal</button>

<div data-modal id="modal-e46ndrv7e9" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-e46ndrv7e9-label" aria-describedby="modal-e46ndrv7e9-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-e46ndrv7e9-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-e46ndrv7e9-heading">Modal heading</p>

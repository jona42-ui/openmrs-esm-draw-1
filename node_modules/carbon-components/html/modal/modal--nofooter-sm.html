...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-e5t5ylh64q">Show
  modal</button>

<div data-modal id="modal-e5t5ylh64q" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-e5t5ylh64q-label" aria-describedby="modal-e5t5ylh64q-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-e5t5ylh64q-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-e5t5ylh64q-heading">Modal heading</p>

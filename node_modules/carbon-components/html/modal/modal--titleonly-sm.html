...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nvmgeais39m">Show
  modal</button>

<div data-modal id="modal-nvmgeais39m" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nvmgeais39m-label" aria-describedby="modal-nvmgeais39m-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nvmgeais39m-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nvmgeais39m-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>

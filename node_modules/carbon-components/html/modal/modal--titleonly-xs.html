...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-036bji89r6hj">Show
  modal</button>

<div data-modal id="modal-036bji89r6hj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-036bji89r6hj-label" aria-describedby="modal-036bji89r6hj-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-036bji89r6hj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-036bji89r6hj-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>

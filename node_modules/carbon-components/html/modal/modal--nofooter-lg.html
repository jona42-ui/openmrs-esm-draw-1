...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-w2mbsmm9ior">Show
  modal</button>

<div data-modal id="modal-w2mbsmm9ior" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-w2mbsmm9ior-label" aria-describedby="modal-w2mbsmm9ior-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-w2mbsmm9ior-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-w2mbsmm9ior-heading">Modal heading</p>

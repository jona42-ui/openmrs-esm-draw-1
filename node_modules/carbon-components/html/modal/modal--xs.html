...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-8lpsvzn1rjy">Show
  modal</button>

<div data-modal id="modal-8lpsvzn1rjy" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-8lpsvzn1rjy-label" aria-describedby="modal-8lpsvzn1rjy-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8lpsvzn1rjy-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8lpsvzn1rjy-heading">Modal heading</p>

...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rprff718tij">Show
  modal</button>

<div data-modal id="modal-rprff718tij" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rprff718tij-label" aria-describedby="modal-rprff718tij-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rprff718tij-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rprff718tij-heading">Modal heading</p>

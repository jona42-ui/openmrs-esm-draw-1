...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-635c5krqk2t">Show
  modal</button>

<div data-modal id="modal-635c5krqk2t" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-635c5krqk2t-label" aria-describedby="modal-635c5krqk2t-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-635c5krqk2t-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-635c5krqk2t-heading">Modal heading</p>

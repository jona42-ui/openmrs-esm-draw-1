...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-enbzitb1nyd">Show
  modal</button>

<div data-modal id="modal-enbzitb1nyd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-enbzitb1nyd-label" aria-describedby="modal-enbzitb1nyd-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-enbzitb1nyd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-enbzitb1nyd-heading">Modal heading</p>

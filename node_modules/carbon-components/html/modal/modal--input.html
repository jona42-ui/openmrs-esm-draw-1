...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mbwvjxofyi">Show
  modal</button>

<div data-modal id="modal-mbwvjxofyi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mbwvjxofyi-label" aria-describedby="modal-mbwvjxofyi-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mbwvjxofyi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mbwvjxofyi-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-mbwvjxofyi" class="bx--label">Text Input label</label>
        <input id="text-input-mbwvjxofyi" type="text" class="bx--text-input" placeholder="Optional placeholder text"

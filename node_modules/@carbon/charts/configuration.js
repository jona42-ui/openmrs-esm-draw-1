...
import { 
// ENUMS
Alignments, GaugeTypes, LegendPositions, TruncationTypes, ToolbarControlTypes, ZoomBarTypes, LegendItemType, TreeTypes, DividerStatus, ChartTheme, Projection, } from './interfaces';
 ...
 */
var thematicChart = Tools.merge({}, chart, {
    thematic: {
...
var choroplethChart = Tools.merge({}, thematicChart, {
    choropleth: {
        colorLegend: {
            type: 'linear',
        },

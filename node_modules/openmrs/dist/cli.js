...
yargs_1.default.command("debug", "Starts a new debugging session of the OpenMRS app shell. This uses Webpack as a debug server with proxy middleware.", (argv) => argv
    ...
    return runCommand("runDebug", Object.assign(Object.assign({ configUrls: args["config-url"] }, args), (0, utils_1.proxyImportmapAndRoutes)(yield (0, utils_1.mergeImportmapAndRoutes)(yield (0, utils_1.getImportmapAndRoutes)(args.importmap, args.routes, args.port), (args["run-project"] || args.runProject) &&
        (yield (0, utils_1.runProject)(args.port, args.sources))), args.backend, args.host, args.port)));
}));
...
yargs_1.default.command("build", "Builds a new app shell.", (argv) => argv
    ...
    return runCommand("runBuild", Object.assign({ configUrls: args["config-url"], configPaths: args["config-path"].map((p) => (0, path_1.resolve)(process.cwd(), p)) }, args));
}));
yargs_1.default.command("assemble", "Assembles an import map incl. all required resources.", (argv) => argv
    ...
    default: false,
    description: "Determines whether to include a content-specific hash for the generated importmap. This is useful if you want to be able to cache the importmap.",
    type: "boolean",
})
    .option("fresh", {
    default: false,
